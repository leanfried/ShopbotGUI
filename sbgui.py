...
class fluChannel:
    def __init__(self, chanNum: int, color: str):
    ...
    def runConstTime(self) -> None:
        ...
        print('Setting channel', self.chanNum,'to', runpressure, 'for', runtime, 's')
    ...
    def zeroChannel(self) -> None:
        print('Setting channel', self.chanNum,'to 0')
...
#             self.fluPlot.critFlag = flag
    ...
    def successLayout(self) -> None:
        ...
        for i in range(self.numChans):
            pc = fluChannel(i, self.pcolors[i])
